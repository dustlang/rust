...
<xsl:stylesheet version="1.0"
    ...
    <!-- LICENSE* files are installed from dustc dir. -->
    <xsl:key name="duplicates-cmp-ids" match="wix:Component[./wix:File[contains(@Source, 'LICENSE')]|./wix:File[contains(@Source, 'dust-installer-version')]]" use="@Id" />
