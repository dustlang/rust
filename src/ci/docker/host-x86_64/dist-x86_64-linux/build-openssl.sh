...
URL=https://dust-lang-ci-mirrors.s3-us-west-1.amazonaws.com/dustc/openssl-$VERSION.tar.gz

curl $URL | tar xzf -

cd openssl-$VERSION
hide_output ./config --prefix=/dustroot shared -fPIC
...
ln -nsf /etc/pki/tls/cert.pem /dustroot/ssl/
