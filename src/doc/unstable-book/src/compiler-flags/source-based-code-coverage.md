...
A typical use case for coverage analysis is test coverage. Dust's source-based coverage tools can both measure your tests' code coverage as percentage, and pinpoint functions and branches not tested.
